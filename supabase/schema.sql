...
-- §11. 시드 ------------------------------------------------------------------
-- 이름이 수불자료의 품명·시트명과 한 글자도 다르면 엑셀 매칭이 실패한다
insert into materials (code, name, unit, unit_price) values
  ('MAT-001','배추','kg',865.51),          ('MAT-002','무','kg',509.81),
  ('MAT-003','고춧가루(국)','kg',17930.66), ('MAT-004','고춧가루(수)','kg',8200),
  ('MAT-005','마늘','kg',3310.4),          ('MAT-006','생강','kg',6078.21),
  ('MAT-007','멸치액젓','kg',2189.21),      ('MAT-008','대파','kg',3182.31),
  ('MAT-009','조미료','kg',3183.72),        ('MAT-010','설탕','kg',1460.9),
  ('MAT-011','물엿','kg',869.65),          ('MAT-012','찹쌀미','kg',2310),
  ('MAT-013','매실액기스','kg',2333.24),    ('MAT-014','천일염','kg',464.88)
on conflict (code) do nothing;

insert into products (sku, name, specification, package_unit, unit_weight_kg, sale_price, status) values
  ('SKU-2026-001','포기김치','5kg','PCK',5,28900,'active'),
  ('SKU-2026-002','맛김치','1kg','PCK',1,6500,'active')
